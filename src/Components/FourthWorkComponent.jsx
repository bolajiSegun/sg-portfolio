import solar from "../assets/femlad.png";
import { Link } from "react-router-dom";

function FourthWorkComponent() {
  return (
    <div className="relative mb-4">
      ...
      <div className="portOverlay absolute top-0 left-0 w-full h-full text-center flex justify-center items-center">
        <Link
          to="https://bolajisegun.github.io/Femlad-Solar-Company/html/"
          target="_blank"
          className="mt-20"
        >
...
export default FourthWorkComponent;
